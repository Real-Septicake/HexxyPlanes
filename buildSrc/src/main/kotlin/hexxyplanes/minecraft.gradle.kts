...
loom {
    ...
    accessWidenerPath = project(":common").file("src/main/resources/hexxyplanes.accesswidener")

    mixin {
        // the default name includes both archivesName and the subproject, resulting in the platform showing up twice
        // default: hexxyplanes-common-common-refmap.json
        // fixed:   hexxyplanes-common.refmap.json
...
publishing {
    publications {
        create<MavenPublication>("HexxyPlanes") {
    ...
    repositories {
        maven {
            ...
            credentials {
                ...
                password = System.getenv("HEXXY_MAVEN_PASSWORD")
            }
        }
    }
}
